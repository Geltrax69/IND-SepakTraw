export const STFI_HERO_DATA = {
  title: 'SEPAKTAKRAW FEDERATION OF INDIA',
  subtitle: 'Official National Governing Body for SepakTakraw in India | Recognized by Ministry of Youth Affairs & Sports (MYAS), Government of India | Affiliated with ISTAF & ASTAF',
  bannerTag: 'OFFICIAL PORTAL • SEPAKTAKRAW FEDERATION OF INDIA',
  heroImage: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=2000&q=90'
};

export const STFI_NAVIGATION_ITEMS = [
  { id: 'home', label: 'Home' },
  {
    id: 'notice',
    label: 'Notice & News',
...
export const STFI_NOTICES = [
  {
    id: 'notice-1',
    date: 'July 18, 2026',
    category: 'Selection Trial',
    badge: 'Urgent',
    title: 'Selection Trials Notification for 34th Senior National Championship & Asian Games Probables',
    desc: 'Official notification regarding national coaching camps and selection trials to be conducted at SAI Center, Bengaluru. All affiliated state units must submit athlete entries before August 10, 2026.',
    documentPdf: 'STFI_Selection_Trial_Circular_2026.pdf'
  },
  {
    id: 'notice-2',
    date: 'July 05, 2026',
    category: 'Elections',
    badge: 'Official',
    title: 'Publication of Electoral Roll & Schedule for STFI General Body Elections (2024-2028)',
    desc: 'Notice issued by the Returning Officer containing guidelines for nomination filings, candidate scrutiny, and general body election voting schedule.',
    documentPdf: 'STFI_Electoral_Roll_Notification_2026.pdf'
  },
  {
    id: 'notice-3',
    date: 'June 22, 2026',
    category: 'Results',
    badge: 'Results',
    title: 'Official Results: 33rd Junior National SepakTakraw Championship (Imphal, Manipur)',
    desc: 'Complete match scores, team standings, and medal winners list for Regu, Double, and Quad events held in Imphal.',
    documentPdf: '33rd_Junior_National_Results.pdf'
  },
  {
    id: 'notice-4',
    date: 'May 14, 2026',
    ...
    badge: 'Compliance',
    title: 'Submission of Audited Financial Accounts & ACTC Calendar FY 2025-2026',
    desc: 'Public disclosure of annual audited financial accounts, statutory auditor statements, and annual competition calendar.',
    documentPdf: 'STFI_Audited_Accounts_2025_26.pdf'
  }
];

export const STFI_RULES_DATA = [
  {
    id: 'rule-regu',
    title: 'Regu Team Event Rules',
    players: '3 Players per Regu (1 Tekong, 2 Inside Feeders/Spikers)',
    court: '13.4m x 6.1m Court Height 1.55m Net',
    description: 'The signature 3-on-3 event. Maximum 3 touches per side using feet, knees, chest, and head before sending the woven ball over the net. No hands or arms permitted.',
    pdf: 'STFI_Regu_Rules_Official.pdf'
  },
  {
    id: 'rule-double',
    title: 'Double Event Rules',
    players: '2 Players per Team (1 Server, 1 Striker)',
    court: '13.4m x 6.1m Court',
    description: 'Fast-paced two-player format testing stamina and aerial precision. Service is made from behind the baseline with 3 set limit to 21 points.',
    pdf: 'STFI_Double_Event_Rules.pdf'
  },
  {
    id: 'rule-quad',
    title: 'Quad Event Rules',
    players: '4 Players per Team (1 Server, 2 Blockers/Spikers, 1 Feeder)',
    court: '13.4m x 6.1m Court',
    description: 'Four-player tactical discipline featuring double net blocks, rapid positional rotations, and power spiking.',
    pdf: 'STFI_Quad_Event_Rules.pdf'
  },
  {
    id: 'rule-beach',
    title: 'Beach Event Rules',
    players: 'Sand Court (3 or 4 Players)',
    court: '13.4m x 6.1m Sand Arena',
    description: 'Outdoor beach sand court rules adapting to wind conditions, sand traction, and beach championship match formats.',
    pdf: 'STFI_Beach_Event_Rules.pdf'
  }
];

export const STFI_MYAS_28_SECTIONS = [
...
export const STFI_EVENTS = [
  {
    id: 'evt-1',
    name: '34th Senior National SepakTakraw Championship 2026',
    dates: 'October 24–28, 2026',
    venue: 'Indira Gandhi Indoor Stadium, New Delhi',
    category: 'Senior National',
    events: 'Regu, Double, Quad & Team Event (Men & Women)'
  },
  {
    id: 'evt-2',
    name: 'Asian Games 2026 National Selection Trials',
    dates: 'November 12–15, 2026',
    venue: 'SAI Netaji Subhas Southern Centre, Bengaluru',
    category: 'Selection Trial',
    events: 'Core Probables Evaluation'
  },
  {
    id: 'evt-3',
    name: '33rd Junior & Sub-Junior National Championship',
    dates: 'December 10–14, 2026',
    venue: 'Khuman Lampak Sports Complex, Imphal, Manipur',
    category: 'Junior National',
    events: 'Boys & Girls (Under-19 & Under-14)'
  }
];

export const STFI_FOOTER_COLUMNS = [
  {
    title: 'Navigation',
    links: ['Home', 'Notice & News', 'Championship Results', 'Event Calendar', 'Official Circulars']
  },
  {
    title: 'Rules & Regulations',
    links: ['Regu Team Rules', 'Double Event Rules', 'Quad Event Rules', 'Beach Event Rules', 'ISTAF International Code']
  },
  {
    title: 'MYAS Compliance',
    links: ['28 Governance Disclosures', 'Audited Accounts', 'ACTC Calendar', 'Anti Doping (NADA/WADA)', 'RTI Disclosures']
  },
  {
    title: 'Contact Federation',
    links: ['Federation Headquarters', 'State Association Contacts', 'Public Information Officer', 'Elections 2024-2028']
  }
];
